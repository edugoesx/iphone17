        ...
        <section className="bg-black py-20 px-6 " id="design">
            <div className="max-w-7xl mx-auto">
                ...
                <div className="text-center mb-16">
                    <h2 className="text-4xl md:text-5xl font-bold mb-4">Estrutura unibody.<br />Eles têm a força.</h2>
                    <p className="text-lg md:text-xl text-gray-400 max-w-3xl mx-auto">Apresentamos o iPhone 17 Pro e o iPhone 17 Pro Max. Projetados de dentro para fora, eles são os modelos de iPhone mais potentes já produzidos. O coração do novo design é a estrutura unibody em alumínio forjado a quente que maximiza o desempenho, a capacidade da bateria e a durabilidade.</p>
                </div>
            </div>
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-8 mb-16 max-w-7xl mx-auto">
                ...
                <div className="bg-gray-900 rounded-3xl p-8">
                    <img className="w-full rounded-2xl mb-4" src="/img/ios-features.jpg" alt="ios-features"></img>
                    <h3 className="font-bold mb-2 text-3xl">iOS 26. Novo visual.<br />Ainda mais mágico.</h3>
                ...
                <div className="bg-gray-900 rounded-3xl p-8 md:p-12 mb-16 md:col-span-2" id="performance">
                    <h3 className="text-4xl font-bold mb-6 text-gradient bg-clip-text text-transparent bg-gradient-to-r from-blue-400 to-purple-600">A18 Pro</h3>
                    <p className="text-gray-300 mb-6">O chip mais poderoso em um smartphone</p>
                    <img className="w-full rounded-2xl mb-4" src="/img/chip-a18-pro.jpg" alt="chip a18 pro"></img>
                ...
                <div className="text-center md:col-span-2" id="camera">
